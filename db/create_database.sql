...
CREATE TABLE Cars (
    ...
    Mark VARCHAR(20) NOT NULL UNIQUE,
...
VALUES ('Lamborghini','Aventador','Manual','Green','https://images-na.ssl-images-amazon.com/images/I/51aN%2BLvNvwL._AC_SX425_.jpg',2),
